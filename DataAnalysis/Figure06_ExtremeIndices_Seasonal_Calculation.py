...
@author: midhunm
"""
from ai4klima.evalmetrics import create_directory
import os
import pickle
import numpy as np
import pandas as pd
...
def main(tag, DATA_PATH):
    ...
    for exp_id, mode in checkdict.items():
        data_dict = {  
            ...
            'AU-NET' : [f'{DATA_PATH}/p02a_hp-b32-r7e4-wmae_{exp_id}_m05_b13_c01_{mode}_out_2001_2023.nc', 'M05: AU-NET'], 
            ...
            'GAN-ENS': [f'{DATA_PATH}/p02a_hp-b32-r7e4-wmae_{exp_id}_eng_b13_c01_{mode}_out_2001_2023.nc', 'GAN-ENS'],
        }
        ...
        SAVE_PATH = "/home/midhunm/AI4KLIM/EXPMNTS/P02A_DeepDown_Generalization/ANALYSE/PLTDATA/FM06_ExtremeIndices_Seasonal" # Edit here
        create_directory(SAVE_PATH)

        try:
            make_eval_table(data_dict, mask_dict, seas_dict, csv_save_path = SAVE_PATH, suffix=f'{tag}.{exp_id}.{mode}', )
...
if __name__ == "__main__":
    ...
    PATH = "/home/midhunm/AI4KLIM/EXPMNTS/P02A_DeepDown_Generalization/ANALYSE/PLTDATA/FM06_ExtremeIndices_Seasonal" # Edit here
    path_dict = {
        "P02A.RX1DAY" : f"{PATH}/DATA_RX1DAY",
        "P02A.R99"    : f"{PATH}/DATA_R99",
        "P02A.R95"    : f"{PATH}/DATA_R95",
        "P02A.R90"    : f"{PATH}/DATA_R90",
    }
